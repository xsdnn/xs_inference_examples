...
void ComputeSsdMobilinet_v1_1_default_1_small(benchmark::State& state, const char*) {
    ...
    conv Conv2d_3_Pointwise(/*in_shape=*/Conv2d_3_Depthwise.out_shape()[0], /*out_channel=*/96, /*kernel_shape=*/{1, 1},
            /*group_count=*/1, /*has_bias=*/true, /*stride_shape=*/{1, 1}, /*dilation_shape=*/{1, 1},
            /*pad_type=*/padding_mode::notset, /*pads=*/{0, 0, 0, 0}, /*activation_type=*/mmpack::Relu,
            /*engine=*/core::backend_t::xnnpack);

    conv Conv2d_4_Depthwise(/*in_shape=*/Conv2d_3_Pointwise.out_shape()[0], /*out_channel=*/96, /*kernel_shape=*/{3, 3},
            /*group_count=*/96, /*has_bias=*/true, /*stride_shape=*/{2, 2}, /*dilation_shape=*/{1, 1},
            /*pad_type=*/padding_mode::notset, /*pads=*/{1, 1, 1, 1}, /*activation_type=*/mmpack::Relu,
            /*engine=*/core::backend_t::xnnpack);

    conv Conv2d_4_Pointwise(/*in_shape=*/Conv2d_4_Depthwise.out_shape()[0], /*out_channel=*/192, /*kernel_shape=*/{1, 1},
            /*group_count=*/1, /*has_bias=*/true, /*stride_shape=*/{1, 1}, /*dilation_shape=*/{1, 1},
            /*pad_type=*/padding_mode::notset, /*pads=*/{0, 0, 0, 0}, /*activation_type=*/mmpack::Relu,
            /*engine=*/core::backend_t::xnnpack);

    conv Conv2d_5_Depthwise(/*in_shape=*/Conv2d_4_Pointwise.out_shape()[0], /*out_channel=*/192, /*kernel_shape=*/{3, 3},
            /*group_count=*/192, /*has_bias=*/true, /*stride_shape=*/{1, 1}, /*dilation_shape=*/{1, 1},
            /*pad_type=*/padding_mode::notset, /*pads=*/{1, 1, 1, 1}, /*activation_type=*/mmpack::Relu,
            /*engine=*/core::backend_t::xnnpack);

    conv Conv2d_5_Pointwise(/*in_shape=*/Conv2d_5_Depthwise.out_shape()[0], /*out_channel=*/192, /*kernel_shape=*/{1, 1},
            /*group_count=*/1, /*has_bias=*/true, /*stride_shape=*/{1, 1}, /*dilation_shape=*/{1, 1},
            /*pad_type=*/padding_mode::notset, /*pads=*/{0, 0, 0, 0}, /*activation_type=*/mmpack::Relu,
            /*engine=*/core::backend_t::xnnpack);

    conv Conv2d_6_Depthwise(/*in_shape=*/Conv2d_5_Pointwise.out_shape()[0], /*out_channel=*/192, /*kernel_shape=*/{3, 3},
            /*group_count=*/192, /*has_bias=*/true, /*stride_shape=*/{2, 2}, /*dilation_shape=*/{1, 1},
            /*pad_type=*/padding_mode::notset, /*pads=*/{0, 0, 1, 1}, /*activation_type=*/mmpack::Relu,
            /*engine=*/core::backend_t::xnnpack);

    conv Conv2d_6_Pointwise(/*in_shape=*/Conv2d_6_Depthwise.out_shape()[0], /*out_channel=*/384, /*kernel_shape=*/{1, 1},
            /*group_count=*/1, /*has_bias=*/true, /*stride_shape=*/{1, 1}, /*dilation_shape=*/{1, 1},
            /*pad_type=*/padding_mode::notset, /*pads=*/{0, 0, 0, 0}, /*activation_type=*/mmpack::Relu,
            /*engine=*/core::backend_t::xnnpack);

    conv Conv2d_7_Depthwise(/*in_shape=*/Conv2d_6_Pointwise.out_shape()[0], /*out_channel=*/384, /*kernel_shape=*/{3, 3},
            /*group_count=*/384, /*has_bias=*/true, /*stride_shape=*/{1, 1}, /*dilation_shape=*/{1, 1},
            /*pad_type=*/padding_mode::notset, /*pads=*/{1, 1, 1, 1}, /*activation_type=*/mmpack::Relu,
            /*engine=*/core::backend_t::xnnpack);

    conv Conv2d_7_Pointwise(/*in_shape=*/Conv2d_7_Depthwise.out_shape()[0], /*out_channel=*/384, /*kernel_shape=*/{1, 1},
            /*group_count=*/1, /*has_bias=*/true, /*stride_shape=*/{1, 1}, /*dilation_shape=*/{1, 1},
            /*pad_type=*/padding_mode::notset, /*pads=*/{0, 0, 0, 0}, /*activation_type=*/mmpack::Relu,
            /*engine=*/core::backend_t::xnnpack);

    conv Conv2d_8_Depthwise(/*in_shape=*/Conv2d_7_Pointwise.out_shape()[0], /*out_channel=*/384, /*kernel_shape=*/{3, 3},
            /*group_count=*/384, /*has_bias=*/true, /*stride_shape=*/{1, 1}, /*dilation_shape=*/{1, 1},
            /*pad_type=*/padding_mode::notset, /*pads=*/{1, 1, 1, 1}, /*activation_type=*/mmpack::Relu,
            /*engine=*/core::backend_t::xnnpack);

    conv Conv2d_8_Pointwise(/*in_shape=*/Conv2d_8_Depthwise.out_shape()[0], /*out_channel=*/384, /*kernel_shape=*/{1, 1},
            /*group_count=*/1, /*has_bias=*/true, /*stride_shape=*/{1, 1}, /*dilation_shape=*/{1, 1},
            /*pad_type=*/padding_mode::notset, /*pads=*/{0, 0, 0, 0}, /*activation_type=*/mmpack::Relu,
            /*engine=*/core::backend_t::xnnpack);

    conv Conv2d_9_Depthwise(/*in_shape=*/Conv2d_8_Pointwise.out_shape()[0], /*out_channel=*/384, /*kernel_shape=*/{3, 3},
            /*group_count=*/384, /*has_bias=*/true, /*stride_shape=*/{1, 1}, /*dilation_shape=*/{1, 1},
            /*pad_type=*/padding_mode::notset, /*pads=*/{1, 1, 1, 1}, /*activation_type=*/mmpack::Relu,
            /*engine=*/core::backend_t::xnnpack);

    conv Conv2d_9_Pointwise(/*in_shape=*/Conv2d_9_Depthwise.out_shape()[0], /*out_channel=*/384, /*kernel_shape=*/{1, 1},
            /*group_count=*/1, /*has_bias=*/true, /*stride_shape=*/{1, 1}, /*dilation_shape=*/{1, 1},
            /*pad_type=*/padding_mode::notset, /*pads=*/{0, 0, 0, 0}, /*activation_type=*/mmpack::Relu,
            /*engine=*/core::backend_t::xnnpack);

    conv Conv2d_10_Depthwise(/*in_shape=*/Conv2d_9_Pointwise.out_shape()[0], /*out_channel=*/384, /*kernel_shape=*/{3, 3},
            /*group_count=*/384, /*has_bias=*/true, /*stride_shape=*/{1, 1}, /*dilation_shape=*/{1, 1},
            /*pad_type=*/padding_mode::notset, /*pads=*/{1, 1, 1, 1}, /*activation_type=*/mmpack::Relu,
            /*engine=*/core::backend_t::xnnpack);

    conv Conv2d_10_Pointwise(/*in_shape=*/Conv2d_10_Depthwise.out_shape()[0], /*out_channel=*/384, /*kernel_shape=*/{1, 1},
            /*group_count=*/1, /*has_bias=*/true, /*stride_shape=*/{1, 1}, /*dilation_shape=*/{1, 1},
            /*pad_type=*/padding_mode::notset, /*pads=*/{0, 0, 0, 0}, /*activation_type=*/mmpack::Relu,
            /*engine=*/core::backend_t::xnnpack);

    conv Conv2d_11_Depthwise(/*in_shape=*/Conv2d_10_Pointwise.out_shape()[0], /*out_channel=*/384, /*kernel_shape=*/{3, 3},
            /*group_count=*/384, /*has_bias=*/true, /*stride_shape=*/{1, 1}, /*dilation_shape=*/{1, 1},
            /*pad_type=*/padding_mode::notset, /*pads=*/{1, 1, 1, 1}, /*activation_type=*/mmpack::Relu,
            /*engine=*/core::backend_t::xnnpack);

    conv Conv2d_11_Pointwise(/*in_shape=*/Conv2d_11_Depthwise.out_shape()[0], /*out_channel=*/384, /*kernel_shape=*/{1, 1},
            /*group_count=*/1, /*has_bias=*/true, /*stride_shape=*/{1, 1}, /*dilation_shape=*/{1, 1},
            /*pad_type=*/padding_mode::notset, /*pads=*/{0, 0, 0, 0}, /*activation_type=*/mmpack::Relu,
            /*engine=*/core::backend_t::xnnpack);
